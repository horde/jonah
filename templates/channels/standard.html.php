...
<tr><td><strong><a target="_blank" href="<?php echo $story['permalink'] ?>"><?php echo $this->story_marker ?> <?php echo $story['title'] ?></a></strong><div style="padding-left:10px"><?php echo $story['description'] ?></div></td></tr>
<?php endforeach ?>
<?php endif ?>
